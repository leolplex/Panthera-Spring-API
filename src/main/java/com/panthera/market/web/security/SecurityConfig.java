...
import com.panthera.market.web.security.filter.JwtFilterRequest;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(pantheraUserDetailService).passwordEncoder(new BCryptPasswordEncoder());
    }
